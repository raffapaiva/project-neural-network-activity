...
Compara a rede Keras do `exemplo4.py` da aula com uma versão maior
(mais neurônios, uma camada oculta a mais) num problema de
classificação não linear (`make_moons`, 500 amostras, ruído 0.20).
